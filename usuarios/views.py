...
def listUsuario(request,user_login):
	
	usuario = UserProfile.objects.get(id=user_login)
	
	context= {
	'usuario':usuario}
	return render(request, 'usuario/arearestritapaciente.html', context=context)